package Furuta_V03
  model Ges_Integration_fin_03
    Modelica.Blocks.Sources.Constant Soll_Pend(k = 0.5/180*3.14159) annotation(
      Placement(transformation(origin = {-150, 30}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Continuous.LimPID PID_lim_Pend(controllerType = Modelica.Blocks.Types.SimpleController.PD, k = 1000, Td = 0.1, Nd = 100) annotation(
    ...
    Modelica.Blocks.Sources.Constant Soll_w_Rot(k = 0) annotation(
      Placement(transformation(origin = {-190, -10}, extent = {{-10, -10}, {10, 10}})));
    Akt_gestuft_fin_03 akt_gestuft_fin_03(Akt_Stufe = 3) annotation(
      Placement(transformation(origin = {-10, 50}, extent = {{-30, -30}, {30, 30}})));
    Pendel_Mechanik_fin_04 pendel_Mechanik_fin_04(phi_0_Pend = 40/180*3.14159, phi_0_Rot = -65/180*3.14159) annotation(
  ...
  equation
    ...
    connect(PID_lim_Rot.u_s, Soll_w_Rot.y) annotation(
    ...
    annotation(
      ...
      Diagram(graphics = {Text(origin = {-137, 65}, extent = {{-41, 19}, {41, -19}}, textString = "Soll_Pend = 0 
> fehlerfreie Winkelmessung Pendellage

Soll_Pend <> 0 
> simulierter Offset-Fehler der Winkelmessung", horizontalAlignment = TextAlignment.Left), Text(origin = {-178, -34}, extent = {{-24, 8}, {24, -8}}, textString = "Soll_w_Rot = 0 
> Rotor soll nach dem 
    Einpendeln still stehen", horizontalAlignment = TextAlignment.Left)}));
  ...
  block Pendel_Mechanik_fin_04
    ...
    //
    inner Modelica.Mechanics.MultiBody.World world(nominalLength = 0.5) annotation(
    ...
    Modelica.Mechanics.MultiBody.Joints.Revolute rev_Stat_Rot(n = {0, 1, 0}, phi(start = phi_0_Rot, fixed = true), useAxisFlange = true, w(start = 0, fixed = true)) annotation(
    ...
    Modelica.Mechanics.MultiBody.Joints.Revolute rev_Rot_Pend(cylinderDiameter(displayUnit = "mm") = 0.007, cylinderLength(displayUnit = "mm") = 0.002, n = {1, 0, 0}, phi(fixed = true, start = phi_0_Pend), useAxisFlange = true, w(start = 0, fixed = true)) annotation(
  ...
  equation
    ...
    connect(Angle_Rot.phi_rel, Out_Angle_Rot) annotation(
      Line(points = {{-58, 32}, {-58, 36}, {10, 36}, {10, 60}, {110, 60}}, color = {0, 0, 127}));
    connect(Torque_Rot.tau, In_Torque_Rot) annotation(
      Line(points = {{-58, 88}, {-58, 94}, {-80, 94}, {-80, 80}, {-120, 80}}, color = {0, 0, 127}));
    connect(relSpeedSensor.flange_a, Angle_Rot.flange_a) annotation(
      Line(points = {{-68, 60}, {-68, 20}}));
    connect(relSpeedSensor.flange_b, Angle_Rot.flange_b) annotation(
      Line(points = {{-48, 60}, {-48, 20}}));
    connect(relSpeedSensor.w_rel, Out_w_Rot) annotation(
      Line(points = {{-58, 50}, {-58, 44}, {-12, 44}, {-12, 80}, {110, 80}}, color = {0, 0, 127}));
    annotation(
  ...
  [rad/s]", horizontalAlignment = TextAlignment.Right)}),
      ...
      Diagram(graphics = {Text(origin = {103, -36}, extent = {{-47, 26}, {47, -26}}, textString = "- Die Parameter können in der Code_Ansicht 
   verändert werden
- mit Reibung und Dämpfung für Rotor und Pendel
- Reibung ist drehzahlunabhängig (Coulomb)
- Dämpfung ist drehzahlabhängig", horizontalAlignment = TextAlignment.Left), Text(origin = {-117, -5}, extent = {{-41, 19}, {41, -19}}, textString = "Furuta-Pendel als parametrierbarer Block
  ...
  block Akt_gestuft_fin_03
    ...
    Modelica.Blocks.Logical.Switch Sw_Out_Trq_Ist annotation(
    ...
    Modelica.Blocks.Sources.BooleanExpression booleanExpression(y = Akt_Stufe <> 1) annotation(
      Placement(transformation(origin = {87, -100}, extent = {{-13, -10}, {13, 10}})));
    Modelica.Blocks.Sources.BooleanExpression booleanExpression1(y = Akt_Stufe == 3) annotation(
      Placement(transformation(origin = {87, -36}, extent = {{-13, -10}, {13, 10}})));
  equation
//
//
    ...
    connect(Sw_Out_Trq_Ist.y, Trq_Ist) annotation(
    ...
    connect(firstOrder.y, Sw_Out_Trq_Ist.u1) annotation(
      Line(points = {{102, -8}, {112, -8}, {112, -22}, {178, -22}}, color = {0, 0, 127}));
    connect(firstOrder1.y, switch2.u1) annotation(
      Line(points = {{93, -70}, {110, -70}, {110, -42}, {138, -42}}, color = {0, 0, 127}));
    connect(switch2.y, Sw_Out_Trq_Ist.u3) annotation(
      Line(points = {{162, -50}, {168, -50}, {168, -38}, {178, -38}}, color = {0, 0, 127}));
    connect(switch2.u3, Lim_Torque1.y) annotation(
      Line(points = {{138, -58}, {130, -58}, {130, -130}, {101, -130}}, color = {0, 0, 127}));
    connect(Lim_Torque1.u, Trq_Soll) annotation(
      Line(points = {{78, -130}, {-40, -130}, {-40, -40}, {-120, -40}}, color = {0, 0, 127}));
    connect(switch2.u2, booleanExpression.y) annotation(
      Line(points = {{138, -50}, {120, -50}, {120, -100}, {101, -100}}, color = {255, 0, 255}));
    connect(Sw_Out_Trq_Ist.u2, booleanExpression1.y) annotation(
      Line(points = {{178, -30}, {112, -30}, {112, -36}, {101, -36}}, color = {255, 0, 255}));
    annotation(
  ...
  [Nm]")}),
      Diagram(graphics = {Text(origin = {24, -125}, extent = {{-12, 3}, {12, -3}}, textString = "Sollmoment"), Text(origin = {113, -119}, extent = {{-13, 7}, {13, -7}}, textString = "Ist-
  Moment
  Stufe 1"), Text(origin = {27, -77}, extent = {{-13, 5}, {13, -5}}, textString = "Soll-
  moment"), Text(origin = {104, -79}, extent = {{-14, 7}, {14, -7}}, textString = "Ist-
  moment
  Stufe 2"), Text(origin = {-204, 33}, extent = {{-60, 39}, {60, -39}}, textString = "Die Parameter können in der Code_Ansicht 
verändert werden
  ...
  moment
  Stufe 3"), Text(origin = {-198, 111}, extent = {{-66, 51}, {66, -51}}, textString = "gestuftes Aktuator-Modell als parametrierbarer Block
  Eingang: 
  - Soll-Moment [Nm]
  ...
  model Test_Aktuator_op_loop
    inner Modelica.Blocks.Noise.GlobalSeed globalSeed;
    Akt_gestuft_fin_03 akt_gestuft_fin_03(Akt_Stufe = 3) annotation(
      Placement(transformation(origin = {-10, 30}, extent = {{-30, -30}, {30, 30}})));
    Modelica.Blocks.Noise.UniformNoise uniformNoise(samplePeriod = 5e-4, y_min = -0.59, y_max = 0.6) annotation(
      Placement(transformation(origin = {-90, -30}, extent = {{-10, -10}, {10, 10}})));
    Schwungmasse_1 schwungmasse_1(H_Deckel = 0.020, w_0_Rot = 0) annotation(
      Placement(transformation(origin = {70, 30}, extent = {{-30, -30}, {30, 30}})));
    Modelica.Blocks.Sources.Step step(height = 0.6, startTime = 0.1) annotation(
      Placement(transformation(origin = {-90, 10}, extent = {{-10, -10}, {10, 10}})));
  equation
    connect(schwungmasse_1.In_Torque_Rot, akt_gestuft_fin_03.Trq_Ist) annotation(
      Line(points = {{40, 30}, {24, 30}}, color = {0, 0, 127}));
    connect(schwungmasse_1.Out_w_Rot, akt_gestuft_fin_03.w_Mot) annotation(
      Line(points = {{103, 48}, {119, 48}, {119, 80}, {-61, 80}, {-61, 42}, {-41, 42}}, color = {0, 0, 127}));
    connect(akt_gestuft_fin_03.Trq_Soll, uniformNoise.y) annotation(
      Line(points = {{-40, 18}, {-60, 18}, {-60, -30}, {-78, -30}}, color = {0, 0, 127}));
    annotation(
      Diagram(graphics = {Text(origin = {-125, 79}, extent = {{-41, 19}, {41, -19}}, textString = "offenes System bestehend aus
- Aktuator
- Schwungmasse", horizontalAlignment = TextAlignment.Left)}),
      experiment(StartTime = 0, StopTime = 8, Tolerance = 1e-05, Interval = 2e-05),
      __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
      __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
  end Test_Aktuator_op_loop;

  block Schwungmasse_1
    //
    //ANFANG Parametrierung des Furuta-Pendels
    //
    // Geometrie
    ...
    parameter Real Rho_Furuta = 7700 "Dichte Pendelbauteile (kg/m^3)";
    // Dichte der Bauteile des Furuta-Pendels in kg/m^3 ; (7700)
    parameter Real w_0_Rot = 30 "w Rotor bei t=0 (rad/s)";
    // Auslenkung-w des Rotors zum Zeitpunkt t= 0 in rad/s
    //
    //ENDE Parametrierung des Furuta-Pendels
    //
    ...
    Modelica.Mechanics.MultiBody.Parts.BodyCylinder Rotor(color = {0, 128, 0}, density = Rho_Furuta, diameter(displayUnit = "mm") = D_Rotor, innerDiameter(displayUnit = "mm") = Di_Rotor, length(displayUnit = "mm") = D_Rotor, r(each displayUnit = "mm") = {0, D_Rotor, 0}) annotation(
      Placement(transformation(origin = {-24, -82}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.MultiBody.Joints.Revolute rev_Stat_Rot(n = {0, 1, 0}, phi(displayUnit = "rad"), useAxisFlange = true, w(start = w_0_Rot, fixed = true)) annotation(
      Placement(transformation(origin = {-48, -82}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.MultiBody.Parts.BodyCylinder Pin_Rot(color = {0, 128, 0}, density = 0, diameter(displayUnit = "mm") = 0.004, length(displayUnit = "mm") = 0.005, r(each displayUnit = "mm") = {(D_Rotor/2 + 0.0015), -0.005, 0}, r_shape(each displayUnit = "mm") = {(D_Rotor/2 - 0.0001), -0.005, 0}) annotation(
      Placement(transformation(origin = {2, -82}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.MultiBody.Parts.BodyCylinder Deckel(color = {128, 128, 0}, density = Rho_Furuta, diameter(displayUnit = "mm") = D_Deckel, length(displayUnit = "mm") = H_Deckel, r(each displayUnit = "mm") = {0, H_Deckel, 0}) annotation(
    ...
    Modelica.Blocks.Interfaces.RealInput In_Torque_Rot annotation(
      Placement(transformation(origin = {-120, 50}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-100, 0}, extent = {{-20, -20}, {20, 20}})));
    Modelica.Blocks.Interfaces.RealOutput Out_Angle_Rot annotation(
      Placement(transformation(origin = {110, -20}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {110, -60}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Interfaces.RealOutput Out_w_Rot annotation(
      Placement(transformation(origin = {110, 40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {110, 60}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Math.Gain Drehzahl(k = 60/2/3.14159) annotation(
      Placement(transformation(origin = {66, 10}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Interfaces.RealOutput n_Rot annotation(
  ...
  equation
    ...
    connect(Deckel.frame_a, Rotor.frame_b) annotation(
      Line(points = {{-8, -64}, {-14, -64}, {-14, -82}}, color = {95, 95, 95}));
    connect(Torque_Rot.flange_b, rev_Stat_Rot.axis) annotation(
      Line(points = {{-48, 34}, {-48, -72}}));
    connect(Angle_Rot.flange_a, Torque_Rot.flange_a) annotation(
      Line(points = {{-68, -38}, {-68, 34}}));
    connect(Angle_Rot.flange_b, Torque_Rot.flange_b) annotation(
      Line(points = {{-48, -38}, {-48, 34}}));
    connect(rev_Stat_Rot.support, Angle_Rot.flange_a) annotation(
      Line(points = {{-54, -72}, {-54, -66}, {-68, -66}, {-68, -38}}));
    connect(Drehzahl.y, n_Rot) annotation(
      Line(points = {{77, 10}, {109, 10}}, color = {0, 0, 127}));
    connect(Out_Angle_Rot, Angle_Rot.phi_rel) annotation(
      Line(points = {{110, -20}, {110, -19}, {-58, -19}, {-58, -27}}, color = {0, 0, 127}));
    connect(Torque_Rot.tau, In_Torque_Rot) annotation(
      Line(points = {{-58, 38}, {-58, 50}, {-120, 50}}, color = {0, 0, 127}));
    connect(relSpeedSensor.flange_a, Angle_Rot.flange_a) annotation(
      Line(points = {{-68, 6}, {-68, -38}}));
    connect(relSpeedSensor.flange_b, Angle_Rot.flange_b) annotation(
      Line(points = {{-48, 6}, {-48, -38}}));
    connect(relSpeedSensor.w_rel, Drehzahl.u) annotation(
      Line(points = {{-58, -4}, {-58, -12}, {40, -12}, {40, 10}, {54, 10}}, color = {0, 0, 127}));
    connect(Out_w_Rot, relSpeedSensor.w_rel) annotation(
      Line(points = {{110, 40}, {20, 40}, {20, -12}, {-58, -12}, {-58, -4}}, color = {0, 0, 127}));
    annotation(
      Icon(graphics = {Rectangle(fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(origin = {-56, 82}, extent = {{-36, 18}, {36, -18}}, textString = "%name"), Text(origin = {46, -59}, extent = {{-40, 15}, {40, -15}}, textString = "Angle_Rot >
  [rad]", horizontalAlignment = TextAlignment.Right), Text(origin = {-51, 1}, extent = {{-25, 15}, {25, -15}}, textString = "> Torque
  [Nm]", horizontalAlignment = TextAlignment.Left), Text(origin = {53, 63}, extent = {{-29, 15}, {29, -15}}, textString = "w_Rot >
  [rad/s]", horizontalAlignment = TextAlignment.Right), Text(origin = {51, -1}, extent = {{-29, 15}, {29, -15}}, textString = "n_Rot >
  [rpm]", horizontalAlignment = TextAlignment.Right)}),
      uses(Modelica(version = "4.1.0")),
      Diagram(graphics = {Text(origin = {53, 81}, extent = {{-41, 19}, {41, -19}}, textString = "passiver Rotor zur 
Belastung des Aktuators", horizontalAlignment = TextAlignment.Left)}),
      experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-05, Interval = 0.0001),
      __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
      __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"));
  end Schwungmasse_1;

  model Ges_Integration_Stoergr_01
    ...
    Modelica.Blocks.Sources.Constant Soll_Pend1(k = 0) annotation(
      Placement(transformation(origin = {-190, -10}, extent = {{-10, -10}, {10, 10}})));
    Akt_gestuft_fin_03 akt_gestuft_fin_03(Akt_Stufe = 1) annotation(
      Placement(transformation(origin = {-10, 50}, extent = {{-30, -30}, {30, 30}})));
    Pendel_Mechanik_fin_04 pendel_Mechanik_fin_04(phi_0_Pend = 5/180*3.14159) annotation(
      Placement(transformation(origin = {70, 50}, extent = {{-30, -30}, {30, 30}})));
    Modelica.Blocks.Noise.UniformNoise StoerNoise(samplePeriod = 2e-04, y_max = 1, y_min = -1) annotation(
    ...
    Modelica.Blocks.Sources.Constant Soll_Pend(k = 0/180*3.14159) annotation(
      Placement(transformation(origin = {-150, 30}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Continuous.FirstOrder Stoergr(k = 1/180*3.14159, T = 0.0030) annotation(
  ...
  equation
    ...
    connect(pendel_Mechanik_fin_04.Out_Angle_Pend, PID_lim_Pend.u_m) annotation(
      Line(points = {{104, 32}, {120, 32}, {120, -20}, {-70, -20}, {-70, 18}}, color = {0, 0, 127}));
    connect(Stoergr.u, StoerNoise.y) annotation(
      Line(points = {{-162, 70}, {-178, 70}}, color = {0, 0, 127}));
    connect(Stoergr.y, add.u1) annotation(
      Line(points = {{-138, 70}, {-132, 70}, {-132, 36}, {-122, 36}}, color = {0, 0, 127}));
    annotation(
      experiment(StartTime = 0, StopTime = 12, Tolerance = 1e-05, Interval = 0.0001),
      __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"),
      __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
      Diagram(graphics = {Text(origin = {-161, 109}, extent = {{-41, 19}, {41, -19}}, textString = "StoerNoise > stochastische Störgröße

Soll_Pend = 0 
> fehlerfreie Winkelmessung Pendellage

Soll_Pend <> 0 
> simulierter Offset-Fehler der Winkelmessung", horizontalAlignment = TextAlignment.Left)}));
  end Ges_Integration_Stoergr_01;

  model Ges_Integration_Abbruch
    Modelica.Blocks.Sources.Constant Soll_Pend(k = 0/180*3.14159) annotation(
      Placement(transformation(origin = {-150, 30}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Continuous.LimPID PID_lim_Pend(controllerType = Modelica.Blocks.Types.SimpleController.PD, k = 1000, Td = 0.05, Nd = 100) annotation(
    ...
    Akt_gestuft_fin_03 akt_gestuft_fin_03(Akt_Stufe = 1) annotation(
      Placement(transformation(origin = {-10, 50}, extent = {{-30, -30}, {30, 30}})));
    Pendel_Mechanik_fin_04 pendel_Mechanik_fin_04(phi_0_Pend = 70/180*3.14159, phi_0_Rot = 70/180*3.14159) annotation(
      Placement(transformation(origin = {70, 50}, extent = {{-30, -30}, {30, 30}})));
    Modelica.Blocks.Logical.Hysteresis hysteresis(uLow = -1, pre_y_start = false, uHigh = 95/180*3.14159) annotation(
      Placement(transformation(origin = {30, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Modelica.Blocks.Math.Abs abs1 annotation(
      Placement(transformation(origin = {70, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Modelica.Blocks.Math.Product product1 annotation(
      Placement(transformation(origin = {-110, -10}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Blocks.Sources.Constant Soll_Pend111(k = 1) annotation(
      Placement(transformation(origin = {-50, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Modelica.Blocks.Logical.Switch switch21 annotation(
      Placement(transformation(origin = {-110, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Modelica.Blocks.Sources.Constant Soll_Pend1111(k = -2) annotation(
      Placement(transformation(origin = {-50, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Modelica.Blocks.Math.Sin sin annotation(
      Placement(transformation(origin = {74, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    Modelica.Blocks.Math.Asin asin annotation(
      Placement(transformation(origin = {34, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  equation
    connect(PID_lim_Pend.u_s, add.y) annotation(
      Line(points = {{-92, 30}, {-99, 30}}, color = {0, 0, 127}));
    connect(PID_lim_Rot.u_s, Soll_Pend1.y) annotation(
      Line(points = {{-162, -10}, {-179, -10}}, color = {0, 0, 127}));
    connect(akt_gestuft_fin_03.Trq_Ist, pendel_Mechanik_fin_04.In_Torque_Rot) annotation(
      Line(points = {{23, 50}, {40, 50}}, color = {0, 0, 127}));
    connect(akt_gestuft_fin_03.w_Mot, pendel_Mechanik_fin_04.Out_w_Rot) annotation(
      Line(points = {{-40, 62}, {-40, 65.5}, {-44, 65.5}, {-44, 63}, {-74, 63}, {-74, 62}, {-82, 62}, {-82, 94}, {220, 94}, {220, 68}, {103, 68}}, color = {0, 0, 127}));
    connect(pendel_Mechanik_fin_04.Out_w_Rot, PID_lim_Rot.u_m) annotation(
      Line(points = {{103, 68}, {220, 68}, {220, -100}, {-150, -100}, {-150, -22}}, color = {0, 0, 127}));
    connect(hysteresis.u, abs1.y) annotation(
      Line(points = {{42, -50}, {59, -50}}, color = {0, 0, 127}));
    connect(pendel_Mechanik_fin_04.Out_Angle_Pend, abs1.u) annotation(
      Line(points = {{103, 32}, {200, 32}, {200, -50}, {82, -50}}, color = {0, 0, 127}));
    connect(PID_lim_Rot.y, product1.u1) annotation(
      Line(points = {{-138, -10}, {-134, -10}, {-134, -4}, {-122, -4}}, color = {0, 0, 127}));
    connect(product1.y, add.u2) annotation(
      Line(points = {{-98, -10}, {-94, -10}, {-94, 12}, {-130, 12}, {-130, 24}, {-122, 24}}, color = {0, 0, 127}));
    connect(switch21.y, product1.u2) annotation(
      Line(points = {{-121, -50}, {-134, -50}, {-134, -16}, {-122, -16}}, color = {0, 0, 127}));
    connect(switch21.u2, hysteresis.y) annotation(
      Line(points = {{-98, -50}, {19, -50}}, color = {255, 0, 255}));
    connect(Soll_Pend1111.y, switch21.u1) annotation(
      Line(points = {{-61, -70}, {-80, -70}, {-80, -58}, {-98, -58}}, color = {0, 0, 127}));
    connect(Soll_Pend111.y, switch21.u3) annotation(
      Line(points = {{-60, -30}, {-80, -30}, {-80, -42}, {-98, -42}}, color = {0, 0, 127}));
    connect(PID_lim_Pend.y, akt_gestuft_fin_03.Trq_Soll) annotation(
      Line(points = {{-68, 30}, {-53, 30}, {-53, 38}, {-40, 38}}, color = {0, 0, 127}));
    connect(asin.y, PID_lim_Pend.u_m) annotation(
      Line(points = {{24, -18}, {-10, -18}, {-10, -2}, {-80, -2}, {-80, 18}}, color = {0, 0, 127}));
    connect(asin.u, sin.y) annotation(
      Line(points = {{46, -18}, {64, -18}}, color = {0, 0, 127}));
    connect(sin.u, pendel_Mechanik_fin_04.Out_Angle_Pend) annotation(
      Line(points = {{86, -18}, {132, -18}, {132, 32}, {104, 32}}, color = {0, 0, 127}));
    connect(add.u1, Soll_Pend.y) annotation(
      Line(points = {{-122, 36}, {-130, 36}, {-130, 30}, {-138, 30}}, color = {0, 0, 127}));
    annotation(
      experiment(StartTime = 0, StopTime = 5, Tolerance = 1e-05, Interval = 0.0001),
      __OpenModelica_simulationFlags(lv = "LOG_STDOUT,LOG_ASSERT,LOG_STATS", s = "dassl", variableFilter = ".*"),
      __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian",
      Diagram(graphics = {Text(origin = {11, -79}, extent = {{-41, 19}, {41, -19}}, textString = "VZW Add-Block für Betrieb Pendel unten
  > aktives Bremsen von Pendel und Rotor 
      durch Lageregelung unten", horizontalAlignment = TextAlignment.Left), Text(origin = {139, -79}, extent = {{-41, 19}, {41, -19}}, textString = "Übergangskriterium im Hystere-Block
Regelung (\"oben\") > Bremsen (\"unten\")", horizontalAlignment = TextAlignment.Left), Text(origin = {-121, 81}, extent = {{-41, 19}, {41, -19}}, textString = "StoerNoise > stochastische Störgröße
